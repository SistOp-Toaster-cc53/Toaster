import {
  script as script4,
  script2 as script5
} from "./chunk-OZAXEKFQ.js";
import {
  OverlayEventBus
} from "./chunk-TG4HSPRE.js";
import {
  FocusTrap
} from "./chunk-4L5HVUTG.js";
import {
  script as script3
} from "./chunk-BH4S4UKA.js";
import {
  script
} from "./chunk-REF5RT7G.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-ZIGRX2TA.js";
import {
  script as script2
} from "./chunk-WYUZUJ3O.js";
import {
  Ripple
} from "./chunk-7DMXIRC3.js";
import {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ($props.alwaysShow ? true : $options.pageLinks && $options.pageLinks.length > 1) ? (openBlock(), createElementBlock("nav", _hoisted_12, [
  ...
  methods: {
    ...
    isRowEditing(rowData) {
      if (rowData && this.editingRows) {
        if (this.dataKey) return this.editingRowKeys ? this.editingRowKeys[ObjectUtils.resolveFieldData(rowData, this.dataKey)] !== void 0 : false;
    ...
    isRowExpanded(rowData) {
      if (rowData && this.expandedRows) {
        if (this.dataKey) return this.expandedRowKeys ? this.expandedRowKeys[ObjectUtils.resolveFieldData(rowData, this.dataKey)] !== void 0 : false;
  ...
  methods: {
    ...
    addMultiSortField(field) {
      ...
      if (index >= 0) {
        ...
        else this.d_multiSortMeta[index] = { field, order: this.d_multiSortMeta[index].order * -1 };
      } else {
    ...
    onColumnHeaderMouseDown(e) {
      ...
      if (this.reorderableColumns && this.columnProp(column, "reorderableColumn") !== false) {
        if (event2.target.nodeName === "INPUT" || event2.target.nodeName === "TEXTAREA" || DomHandler.hasClass(event2.target, "p-column-resizer")) event2.currentTarget.draggable = false;
    ...
    onRowMouseDown(event2) {
      if (DomHandler.hasClass(event2.target, "p-datatable-reorderablerow-handle")) event2.currentTarget.draggable = true;
